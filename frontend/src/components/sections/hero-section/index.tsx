        ...
        <div className="wrapper">
          ...
          <div className="max-w-[800px] mx-auto">
            ...
            <div className="text-center pb-16">
              ...
              <Subheading text="AI-Powered Blogging Platform" />

              <h1 className="text-gray-700 mx-auto font-bold mb-4 text-4xl sm:text-[50px] dark:text-white/90 sm:leading-[64px] max-w-[700px]">
                Inkly — Blogs, powered by intelligence.
              </h1>

              <p className="max-w-[537px] text-center mx-auto dark:text-gray-400 text-gray-500 text-base">
                Create SEO-optimized blogs using AI, streamline your writing workflow, and publish high-quality content faster with intelligent blogging tools.
              </p>
